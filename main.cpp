...
// A couple structs to hold our Vertex and Polygon data (for file reading) and DirectX Vertex data
struct stXYZ
{
    float x, y, z;
};
...
// ...For some reason, we get linker errors if this function isn't static. I have no idea why.
...
static void DrawShape()
{
    ...
    for (int i = 0; i < iNum_polys; i++)
    {
        ...
        myVertices[index].color = 0xff00ff00;
        index++;
